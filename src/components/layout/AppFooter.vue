...
<template>
  <footer style="background-color: #2F4A3A;" class="text-white">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div class="lg:col-span-1">
          ...
          <div class="flex items-center gap-3">
            <a
              href="https://facebook.com/desapandansari"
              target="_blank"
            ...
            <a
              href="https://instagram.com/desapandansari"
              target="_blank"
              rel="noopener noreferrer"
              class="w-9 h-9 rounded-lg bg-white/10 flex items-center justify-center hover:bg-primary hover:text-heading transition-colors"
            ...
            <a
              href="https://youtube.com/@desapandansari"
              target="_blank"
              rel="noopener noreferrer"
              class="w-9 h-9 rounded-lg bg-white/10 flex items-center justify-center hover:bg-primary hover:text-heading transition-colors"
              aria-label="YouTube"
        ...
        <div>
          ...
          <ul class="space-y-2.5">
            <li v-for="link in quickLinks" :key="link.to">
              ...
              >
                <span class="w-1 h-1 rounded-full bg-primary opacity-0 group-hover:opacity-100 transition-opacity flex-shrink-0"></span>
                {{ link.label }}
              </RouterLink>
            </li>
          </ul>
        ...
        <div>
          ...
          <ul class="space-y-3.5">
            <li class="flex gap-3 text-sm text-white/70">
              ...
              <span>Desa Pandansari, Kec. Batang, Kab. Batang, Jawa Tengah 51212</span>
            </li>
            <li>
              <a
              ...
              >
                ...
                <span>+62 285 123456</span>
              </a>
            </li>
            <li>
              <a
                href="mailto:info@pandansari.desa.id"
                class="flex gap-3 text-sm text-white/70 hover:text-primary transition-colors"
              >
                <MailIcon class="w-4 h-4 text-primary flex-shrink-0 mt-0.5" />
                <span>info@pandansari.desa.id</span>
              </a>
            </li>
          </ul>
    ...
    <div class="border-t border-white/10">
      <div class="container-site py-5 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-white/45">
        <p>© {{ currentYear }} Desa Pandansari. Hak cipta dilindungi.</p>
        <p>
          Dirancang dengan ❤️ untuk kemajuan Desa Pandansari
        </p>
      </div>
    </div>
  </footer>
